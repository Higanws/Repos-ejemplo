...
variable "phase1_repository_root" {
  type        = string
  default     = null
  description = "Raíz absoluta de este repo si Terraform no vive en terraform/envs/prod respecto a lambdas/ y orchestration/."
}
...
variable "ingest_api_secret_name" {
  type        = string
  default     = "reporting/prod/apis/finanzas"
